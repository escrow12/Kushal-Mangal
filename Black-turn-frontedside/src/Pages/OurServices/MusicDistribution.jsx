        ...
        <div className="flex flex-col lg:flex-row gap-12 sm:gap-16 lg:gap-20 items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 mb-4 sm:mb-6 text-base sm:text-lg leading-relaxed">
              Kushal Mangal never takes a cut of your deals. Each penny you gain is put right into you're the Black Turn Digital Private Limited account. At Black Turn, we know that your money matters and we respect your passion for music.Comprehensive Sales Data
            </p>
