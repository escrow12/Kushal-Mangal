...
function Home() {
  ...
  const steps = [
    ...
    { id: 2, title: 'TheKushalEntertainment.com', icon: Monitor },
  ...
  const testimonials = [
    {
      id: 1,
      title: "YT World",
      content: "Hello, Team The Kushal Entertainment Digital Private Limited,The attention to detail with which you helped me understand the initial concept of digital distribution platform and how can I make more revenue is in a league of its own 👏. I am incredibly pleased with the quality of customer service provided to me🤟🤟🤟🤟.The best service provider I have ever met. 😊😊😊😊😊😊",
      date: "18. June, 2021.",
      img: client1,
      rating: 5
    },
    ...
    },
    {
      ...
      content: "I researched several digital distribution platforms, but among them all, I really liked The Kushal Entertainment Digital Private Limited Platform. Among the many reasons I chose The Kushal Entertainment Trun is for a few reasons such as It is the only platform that provides us with free caller tune conversions, through which we can increase our revenue. The second is free ISRC and UPC codes, ISRC and UPC codes are a paid service on many platforms, while this important service is free on The Kushal Entertainment Digital Private Limited. Third, the only paid platform gives us up to 95% of revenue which is a huge amount for me, and best of all Instant service, reply and solution. Industry Khatam Bhai..... Industry Khatam..... Guys, I must say The Kushal Entertainment Digital Private Limited Rocks Man...",
      date: "16.June, 2021.",
      img: client5,
      rating: 5
    },
    ...
    },
    {
      ...
      content: "Amazing budget service with instant response. But I must say that The Kushal Entertainment Digital Private Limited platform helped me a lot to generate my first revenue.",
      date: "15.June, 2021.",
      img: silder,
      rating: 5
    },
    {
      id: 8,
      title: "Mudit Chauhan",
      content: "In the digital distribution industry where customers are worried about how to start, how to manage, The Kushal Entertainment Digital Private Limited does it all for you. It is the only easy-to-use platform of its kind where uploading songs is a game and generating handsome revenue seems like My Dreams Come True.... The Kushal Entertainment Digital Private Limited Rocks..... Highly Recommended",
      date: "14.June, 2021.",
      img: client7,
      rating: 5
    },
    {
      id: 9,
      title: "Ankur Chauhan",
      content: "This Is One Of best Music Distribution company Plus apni indian company hai Apni indian company ko support kare guys Thank You So Much The Kushal Entertainment Digital Private Limited 🙌🙌",
      date: "11.June, 2021.",
      img: client7,
      rating: 5
    }
  ...
  const according = [
    ...
    },
    {
      ...
      description: "Call Any Time : +919729786689 Mail us : contact@TheKushalEntertainment.com"
    },
    {
  ...
  return (
    ...
    <Header/>
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center relative z-10">
          ...
          <div className="text-center xl:text-left">
            ...
            <p className="text-gray-700 mb-6 text-base md:text-[16px] max-w-[650px] mx-auto xl:mx-0">
              The Kushal Entertainment Digital Private Limited is your gateway to global music distribution, empowering artists to seamlessly
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-900 text-lg leading-relaxed font-medium">
                  Track Your Growth, Earnings & Opportunities – With The Kushal Entertainment Digital Private Limited
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-500 leading-relaxed">
                  The Kushal Entertainment Digital Private Limited introduces a smart, auto-updated system that manages all revenue
                ...
                >
                  <div className="space-y-3">
                    <p className="text-[#b8dce3] text-sm sm:text-base font-medium">
                      Elevate Your Music Career with The Kushal Entertainment Digital Private Limited
                    </p>
      ...
      {/* silder section */}
      <div className="bg-white mt-6 px-4 sm:px-6 md:px-8 overflow-hidden">
        {/* Section Header */}
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="mt-4 text-base sm:text-lg text-gray-600">
            Join a community of thriving musicians who trust The Kushal Entertainment Digital Private Limited to amplify their reach and revenue.
          </p>
        </div>
    ...
    `}</style>
     ...
     <div className="bg-white flex flex-col lg:flex-row items-center justify-between mx-auto lg:max-w-4xl px-4 py-6">
  ...
  <div className="flex-1 max-w-md text-center lg:text-left">
    ...
    <p className="text-lg text-gray-600 mb-4">
      Music Distribution India - The Kushal Entertainment Digital Private Limited
    </p>
    ...
    <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-3 bg-[#005F73] text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors"
      >
  ...
  <div className="flex-1 flex justify-center relative w-full mt-6 lg:mt-0">
    {/* Smaller circle behind */}
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-56 sm:w-64 md:w-72 h-56 sm:h-64 md:h-72 rounded-full bg-[#005F73] opacity-90 z-0"></div>

    {/* Taller phone container in front */}
    <div className="relative z-10 w-60 sm:w-64 md:w-72 h-[700px] sm:h-[740px] md:h-[780px] rounded-[3rem] p-2 overflow-visible">
      <img src={phone} alt="App Phone" className="w-full h-full object-contain" />
    </div>
  </div>
</div>
