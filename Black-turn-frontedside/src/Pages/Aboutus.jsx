                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                      ...
                      <div>
                        ...
                        <h2 className="text-xl md:text-xl  text-gray-900 leading-snug mb-6">
                          <span className='font-medium'>Kushal Mangal</span> is built for independent musicians who want full control over their music. We help you distribute your songs to over 150 platforms like Spotify, Apple Music, JioSaavn, and more quickly and easily.
                        </h2>
...
<p className='text-xl mb-6'>Whether you're just starting out or already making waves, we’re here to support your journey.</p>
                      ...
                      <h4 className='text-2xl font-bold'>Kushal Mangal – where your music meets the world.</h4>
                      </div>
                    </div>
                  </section>
